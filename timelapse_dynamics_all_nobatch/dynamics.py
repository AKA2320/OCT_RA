...
if __name__ == '__main__':
    ...
    os.makedirs('mask_top_withH2O2',exist_ok=True)
    for idx, img in enumerate(masks):
        cv2.imwrite(f'mask_top_withH2O2/mask_{idx}.PNG',(min_max(img)*((2**8)-1)).astype(np.uint8))

    with open(f'mask_top_withH2O2.pickle', 'wb') as handle:
