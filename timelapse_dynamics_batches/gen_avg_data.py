...
os.chdir('/Users/akapatil/Documents/OCT/timelapse/inter_volume_registered')

if __name__ == '__main__':
    # num = int(sys.argv[1])
    path = 'Timelapse_with_H2O2/registered_cropped_top/'
    save_path = '/Users/akapatil/Documents/OCT/timelapse_dynamics_batches/avg_data/' + 'avg_withH2O2_standard_inter.pickle'
